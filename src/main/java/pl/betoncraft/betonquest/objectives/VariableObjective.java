...
public class VariableObjective extends Objective implements Listener {
    ...
    public void onChat(AsyncPlayerChatEvent event) {
        ...
        if (event.getMessage().matches("[a-zA-Z]*: .*")) {
            ...
            ((VariableData) dataMap.get(uuid)).add(key, value);
     ...
     * objective
     */
    public boolean store(UUID uuid, String key, String value) {
        VariableData data = (VariableData) dataMap.get(uuid);
        if (data == null) {
            return false;
        }
        data.add(key, value);
    ...
    public String getProperty(String name, UUID uuid) {
        String value = ((VariableData) dataMap.get(uuid)).get(name);
    ...
    public static class VariableData extends ObjectiveData {
        ...
        public VariableData(String instruction, UUID uuid, String objID) {

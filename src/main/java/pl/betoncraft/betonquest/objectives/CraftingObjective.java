...
public class CraftingObjective extends Objective implements Listener {
    ...
    public void onCrafting(CraftItemEvent event) {
        if (event.getWhoClicked() instanceof Player) {
            ...
            CraftData playerData = (CraftData) dataMap.get(uuid);
            if (containsPlayer(uuid) && item.compare(player, event.getRecipe().getResult()) && checkConditions(uuid)) {
    ...
    public String getProperty(String name, UUID uuid) {
        if (name.equalsIgnoreCase("left")) {
            return Integer.toString(amount - ((CraftData) dataMap.get(uuid)).getAmount());
        } else if (name.equalsIgnoreCase("amount")) {
            return Integer.toString(((CraftData) dataMap.get(uuid)).getAmount());
        }
        return "";
    }
    ...
    public static class CraftData extends ObjectiveData {
        ...
        public CraftData(String instruction, UUID uuid, String objID) {

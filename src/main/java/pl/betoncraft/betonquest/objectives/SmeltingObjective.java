...
public class SmeltingObjective extends Objective implements Listener {
    ...
    public void onSmelting(FurnaceExtractEvent event) {
        ...
        if (containsPlayer(uuid) && event.getItemType().equals(material) && checkConditions(uuid)) {
            SmeltData playerData = (SmeltData) dataMap.get(uuid);
    ...
    public String getProperty(String name, UUID uuid) {
        if (name.equalsIgnoreCase("left")) {
            return Integer.toString(amount - ((SmeltData) dataMap.get(uuid)).getAmount());
        } else if (name.equalsIgnoreCase("amount")) {
            return Integer.toString(((SmeltData) dataMap.get(uuid)).getAmount());
        }
        return "";
    }
    ...
    public static class SmeltData extends ObjectiveData {
        ...
        public SmeltData(String instruction, UUID uuid, String objID) {

...
import pl.betoncraft.betonquest.core.id.*;
...
public class Instruction {
    ...
    public Instruction(ID id, String instruction) {
        try {
            this.id = id == null ? new NoID() : id;
    ...
    public LocationData getLocation(String string) throws InstructionParseException {
        ...
        try {
            return new LocationData(string);
    ...
    public VariableNumber getVarNum(String string) throws InstructionParseException {
        ...
        try {
            return new VariableNumber(string);
    ...
    private QuestItem getQuestItem(String string) throws InstructionParseException {
        ...
        try {
            return new QuestItem(new ItemID(string));
    ...
    public class Item {
        ...
        public boolean isItemEqual(Player player, ItemStack item) {

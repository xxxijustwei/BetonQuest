...
public class PartialDateCondition extends Condition {
    ...
    public boolean check(UUID uuid) throws QuestRuntimeException {
        ...
        if (dayOfMonth != null) {
            ...
            if (this.dayOfMonth.stream().noneMatch(interval -> interval.isWithin(day))) return false;
        ...
        if (month != null) {
            ...
            if (this.month.stream().noneMatch(interval -> interval.isWithin(month))) return false;

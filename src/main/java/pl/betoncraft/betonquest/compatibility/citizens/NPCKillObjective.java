...
public class NPCKillObjective extends Objective implements Listener {
    ...
    public void onNpcKill(MobKilledEvent event) {
        ...
        NPCData playerData = (NPCData) dataMap.get(uuid);
    ...
    public String getProperty(String name, UUID uuid) {
        if (name.equalsIgnoreCase("left")) {
            return Integer.toString(amount - ((NPCData) dataMap.get(uuid)).getAmount());
        } else if (name.equalsIgnoreCase("amount")) {
            return Integer.toString(((NPCData) dataMap.get(uuid)).getAmount());
        }
        return "";
    }
    ...
    public static class NPCData extends ObjectiveData {
        ...
        public NPCData(String instruction, UUID uuid, String objID) {

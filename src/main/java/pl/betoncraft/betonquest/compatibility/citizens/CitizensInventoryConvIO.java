...
import pl.betoncraft.betonquest.conversation.sub.InventoryConvIO;
...
public class CitizensInventoryConvIO extends InventoryConvIO {
    ...
    public CitizensInventoryConvIO(Conversation conv, UUID uuid) {
        super(conv, uuid);
    }
    ...
    public void display() {
        ...
        if (conv instanceof CitizensConversation) {
            ...
            String texture = citizensConv.getNPC().getOrAddTrait(SkinTrait.class).getTexture();
            ...
            if (texture != null) { // Can be null if not cached yet
                ...
                try {
                    ...
                    Object property = propertyClass
                            ...
                            .newInstance("textures", texture, citizensConv.getNPC().getOrAddTrait(SkinTrait.class).getSignature());
    ...
    public static class CitizensCombined extends CitizensInventoryConvIO {
        ...
        public CitizensCombined(Conversation conv, UUID uuid) {
            super(conv, uuid);

...
import pl.betoncraft.betonquest.core.id.ID;
...
abstract public class Condition {
     ...
     *
     * @param uuid ID of the player for whom the condition will be checked
     * @return the result of the check
     * @throws QuestRuntimeException when an error happens at runtime (for example a numeric
     *                               variable resolves to a string)
     */
    abstract public boolean check(UUID uuid) throws QuestRuntimeException;
}
